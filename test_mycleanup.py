...
class VersionedPatternCheckerTest(unittest.TestCase):
    ...
    def test_path_with_simple_dash_should_return_true(self):
        self.assertTrue(is_matching_versioned_pattern('/myfile-012345678901.js'))

    def test_path_in_subdirectories_should_return_true(self):
        self.assertTrue(is_matching_versioned_pattern('/folder/myfile-012345678901.css'))

    def test_path_with_multiple_dashes_in_path_should_return_true(self):
        self.assertTrue(is_matching_versioned_pattern('/fol-der/my-file-012345678901.css'))

    def test_path_with_multiple_dots_in_path_should_return_true(self):
        self.assertTrue(is_matching_versioned_pattern('/fol.der/my.file0001v1.2.3-012345678901.css'))

    def test_path_without_dash_in_filename_should_return_false(self):
        self.assertFalse(is_matching_versioned_pattern('/folder/myfile012345678901.js'))

    def test_path_with_version_length_11_should_return_false(self):
        self.assertFalse(is_matching_versioned_pattern('/myfile-12345678901.js'))
    ...
    def test_path_with_version_length_13_should_return_false(self):
        self.assertFalse(is_matching_versioned_pattern('/myfile-0123456789012.js'))

    def test_path_with_version_length_12_but_not_all_numbers_should_return_false(self):
        self.assertFalse(is_matching_versioned_pattern('/myfile-0L234S67B9D5.js'))
...
class GetMatchingKeysIntegrationTest(unittest.TestCase):
    ...
    def test_get_matched_pattern_key_with_prefix_should_return_correct_item(self):
        paths = ['prefix1/d/file1.css',
                 'prefix1/d/file2.css',
                 'prefix1/d/file3-012345678901.css',
                 'prefix2/d/file4-123456789012.js',
                 'prefix2/d/file5.js',
                 'prefix3/d/file6-234567890123.png',
        ...
        self.assertIn('prefix1/d/file3-012345678901.css', result1[0].key)

        result2 = get_all_matching_keys(bucket, 'prefix2')
        self.assertIn('prefix2/d/file4-123456789012.js', result2[0].key)

        result3 = get_all_matching_keys(bucket, 'prefix3')
        self.assertIn('prefix3/d/file6-234567890123.png', result3[0].key)
...
class CleanupMainIntegrationTest(unittest.TestCase):
    ...
    def test_end_to_end_cleanup_should_delete_files_with_matching_pattern(self):
        ...
        upload('fixtures/end_to_end/scripts/apply.js', 'scripts/apply-123456789012.js', 'js', self.bucket_js)
        ...
        expected_string_outputs = [
            'Deleted http://myrandombucket-0001.s3.amazonaws.com/css/common-012345678901.css',
            'Deleted http://myrandombucket-0002.s3.amazonaws.com/scripts/apply-123456789012.js',
            'Deleted http://myrandombucket-0003.s3.amazonaws.com/images/image001-234567890123.png']

        for line in expected_string_outputs:
            self.assertIn(line, output)

        self.assertFalse(exists('css/common-012345678901.css', self.bucket_css))
        self.assertFalse(exists('scripts/apply-123456789012.js', self.bucket_js))
        self.assertFalse(exists('images/image001-234567890123.png', self.bucket_image))
    ...
    def test_end_to_end_cleanup_should_skip_files_indexed_in_xml(self):
        ...
        upload('fixtures/end_to_end/css/to_persist_cleanup.css', 'css/to_persist_cleanup-012345678901.css', 'css', self.bucket_css)
        self.assertTrue(exists('css/to_persist_cleanup-012345678901.css', self.bucket_css))

        output = self.execute()

        expected_string_outputs = [
            'Skipping deletion of http://myrandombucket-0001.s3.amazonaws.com/css/to_persist_cleanup-012345678901.css, '
